...
<body class="bg-surface text-on-surface" data-theme="portal">
    ...
    <aside
        ...
        <div class="px-6 mb-8 flex items-center gap-3">
            ...
            <div>
                <h1 class="font-headline text-xl text-[#ffffff]" style="">OJT Portal</h1>
                <p class="text-[10px] uppercase tracking-widest text-[#faf1f8]/70" style="">Academic Editorial</p>
            </div>
        </div>
        <nav class="flex-1">
        ...
        <div class="mt-auto pt-4 border-t border-[#ffffff]/10">
            <a class="text-[#faf1f8]/70 hover:text-[#ffffff] mx-2 my-1 px-4 py-3 flex items-center gap-3 text-sm font-medium hover:bg-[#ffffff]/5 transition-all duration-300"
                href="#">
